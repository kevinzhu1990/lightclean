# [1.4.0](https://github.com/kevinzhu1990/lightclean/compare/v1.3.5...v1.4.0) (2026-09-25)
## [1.3.5](https://github.com/kevinzhu1990/lightclean/compare/v1.3.4...v1.3.5) (2026-09-24)
...
- 新增“授权与套餐”页面，显示30天试用、套餐价格、到期时间和当前设备。
- 付费授权改为完全离线模式：设备申请码、卖家签名激活码和本机公钥验证。
- 新增卖家本地发码工具；400个购买兑换码继续有效，并保持一码绑定一台电脑。

### 安全与隐私

- 激活和日常使用均无需联网，不连接授权服务器，也不上传电脑资料。
- 私钥仅保存在卖家电脑的仓库外目录，安装包和公开GitHub仓库只包含公钥。
- 激活码与设备绑定，被修改或复制到其他电脑时会被拒绝。
